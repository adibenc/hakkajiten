...
<div class="container-fluid">
	<div role="navigation" class="navbox" aria-labelledby="Engineering" style="padding:3px">
		<table class="nowraplinks hlist mw-collapsible autocollapse navbox-inner mw-made-collapsible"
			...
			<tbody>
				<tr>
					<th scope="col" class="navbox-title" colspan="3"><button type="button"
						...
						<div class="navbar plainlinks hlist navbar-mini">
							<ul>
								<li class="nv-view"><a href="/wiki/Template:Engineering_fields"
										title="Template:Engineering fields"><abbr title="View this template"
											style=";;background:none transparent;border:none;box-shadow:none;padding:0;">v</abbr></a>
								</li>
								<li class="nv-talk"><a href="/wiki/Template_talk:Engineering_fields"
										title="Template talk:Engineering fields"><abbr title="Discuss this template"
											style=";;background:none transparent;border:none;box-shadow:none;padding:0;">t</abbr></a>
								</li>
								<li class="nv-edit"><a href="/wiki/Special:EditPage/Template:Engineering_fields"
										title="Special:EditPage/Template:Engineering fields"><abbr
											title="Edit this template"
											style=";;background:none transparent;border:none;box-shadow:none;padding:0;">e</abbr></a>
								</li>
							</ul>
						</div>
						<div id="Engineering" style="font-size:114%;margin:0 4em"><a href="/wiki/Engineering"
								title="Engineering">Engineering</a></div>
					</th>
				</tr>
				<tr style="">
				...
				<tr style="">
					<th scope="row" class="navbox-group" style="width:1%">Specialties<br>and<br><a
							href="/wiki/Interdisciplinarity" title="Interdisciplinarity">Interdisciplinarity</a>
					</th>
							...
							<tbody>
								<tr>
									<th scope="row" class="navbox-group" style="width:1%"><a
											href="/wiki/Civil_engineering" title="Civil engineering">Civil</a></th>
									<td class="navbox-list-with-group navbox-list navbox-odd"
										style="width:100%;padding:0">
										<div style="padding:0 0.25em">
											<ul>
												<li><a href="/wiki/Architectural_engineering"
														title="Architectural engineering">Architectural</a></li>
												<li><a href="/wiki/Coastal_engineering"
														title="Coastal engineering">Coastal</a></li>
												<li><a href="/wiki/Construction_engineering"
														title="Construction engineering">Construction</a></li>
												<li><a href="/wiki/Earthquake_engineering"
														title="Earthquake engineering">Earthquake</a></li>
												<li><a href="/wiki/Environmental_engineering"
														title="Environmental engineering">Environmental</a>
													<ul>
														<li><a href="/wiki/Ecological_engineering"
																title="Ecological engineering">Ecological</a></li>
														<li><a href="/wiki/Sanitary_engineering"
																title="Sanitary engineering">Sanitary</a></li>
													</ul>
												</li>
												<li><a href="/wiki/Geological_engineering"
														title="Geological engineering">Geological</a></li>
												<li><a href="/wiki/Geotechnical_engineering"
														title="Geotechnical engineering">Geotechnical</a></li>
												<li><a href="/wiki/Hydraulic_engineering"
														title="Hydraulic engineering">Hydraulic</a></li>
												<li><a href="/wiki/Mining_engineering"
														title="Mining engineering">Mining</a></li>
												<li><a href="/wiki/Offshore_engineering" class="mw-redirect"
														title="Offshore engineering">Offshore</a></li>
												<li><a href="/wiki/River_engineering"
														title="River engineering">River</a></li>
												<li><a href="/wiki/Structural_engineering"
														title="Structural engineering">Structural</a></li>
												<li><a href="/wiki/Transportation_engineering"
														title="Transportation engineering">Transportation</a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									<th scope="row" class="navbox-group" style="width:1%"><a
											href="/wiki/Mechanical_engineering"
											title="Mechanical engineering">Mechanical</a></th>
									<td class="navbox-list-with-group navbox-list navbox-even"
										style="width:100%;padding:0">
										<div style="padding:0 0.25em">
											<ul>
												<li><a href="/wiki/Acoustical_engineering"
														title="Acoustical engineering">Acoustical</a></li>
												<li><a href="/wiki/Aerospace_engineering"
														title="Aerospace engineering">Aerospace</a></li>
												<li><a href="/wiki/Automotive_engineering"
														title="Automotive engineering">Automotive</a></li>
												<li><a href="/wiki/Energy_engineering"
														title="Energy engineering">Energy</a></li>
												<li><a href="/wiki/HVAC" class="mw-redirect" title="HVAC">HVAC</a>
												</li>
												<li><a href="/wiki/Manufacturing_engineering"
												...
												<li><a href="/wiki/Sports_engineering"
														title="Sports engineering">Sports</a></li>
												<li><a href="/wiki/Tribology" title="Tribology">Tribology</a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									<th scope="row" class="navbox-group" style="width:1%"><a
											href="/wiki/Electrical_engineering"
											title="Electrical engineering">Electrical</a></th>
									<td class="navbox-list-with-group navbox-list navbox-odd"
										style="width:100%;padding:0">
										<div style="padding:0 0.25em">
											<ul>
												<li><a href="/wiki/Broadcast_engineering"
														title="Broadcast engineering">Broadcast</a></li>
												<li><a class="mw-selflink selflink">Computer</a>
													<ul>
														<li><a href="/wiki/Outline_of_computer_engineering"
																title="Outline of computer engineering">outline</a>
														</li>
													</ul>
												</li>
												<li><a href="/wiki/Control_engineering"
														title="Control engineering">Control</a></li>
												<li><a href="/wiki/Electromechanics"
														title="Electromechanics">Electromechanics</a></li>
												<li><a href="/wiki/Electronic_engineering"
														title="Electronic engineering">Electronics</a>
													<ul>
														<li><a href="/wiki/Avionics" title="Avionics">Avionics</a>
														</li>
													</ul>
												</li>
												<li><a href="/wiki/Microwave_engineering"
														title="Microwave engineering">Microwaves</a></li>
												<li><a href="/wiki/Optical_engineering"
														title="Optical engineering">Optical</a></li>
												<li><a href="/wiki/Photonics" title="Photonics">Photonics</a></li>
												<li><a href="/wiki/Power_engineering"
														title="Power engineering">Power</a></li>
												<li><a href="/wiki/Radio-frequency_engineering"
														title="Radio-frequency engineering">Radio frequency</a></li>
												<li><a href="/wiki/Telecommunications_engineering"
														title="Telecommunications engineering">Telecommunications</a>
												</li>
											</ul>
										</div>
									</td>
								...
								<tr>
									...
									<td class="navbox-list-with-group navbox-list navbox-even"
										...
										<div style="padding:0 0.25em">
											<ul>
												<li><a href="/wiki/Biochemical_engineering"
														title="Biochemical engineering">Biochemical</a></li>
												<li><a href="/wiki/Biological_engineering"
														title="Biological engineering">Biological</a>
													<ul>
														<li><a href="/wiki/Biomaterial"
																title="Biomaterial">Biomaterial</a></li>
														<li><a href="/wiki/Bioresource_engineering"
																title="Bioresource engineering">Bioresource</a></li>
														<li><a href="/wiki/Genetic_engineering"
																title="Genetic engineering">Genetic</a></li>
														<li><a href="/wiki/Synthetic_biology"
																title="Synthetic biology">Synthetic biology</a></li>
														<li><a href="/wiki/Tissue_engineering"
																title="Tissue engineering">Tissue</a></li>
													</ul>
												</li>
												...
												<li><a href="/wiki/Paper_engineering"
														title="Paper engineering">Paper</a></li>
												<li><a href="/wiki/Petroleum_engineering"
														title="Petroleum engineering">Petroleum</a></li>
												<li><a href="/wiki/Process_engineering"
														title="Process engineering">Process</a></li>
												<li><a href="/wiki/Chemical_reaction_engineering"
														title="Chemical reaction engineering">Reaction</a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="navbox-list-with-group navbox-list navbox-odd"
										...
										<div style="padding:0 0.25em">
											<ul>
												<li><a href="/wiki/Agricultural_engineering"
														title="Agricultural engineering">Agricultural</a></li>
												<li><a href="/wiki/Audio_engineer" title="Audio engineer">Audio</a>
												</li>
												<li><a href="/wiki/Biomedical_engineering"
														title="Biomedical engineering">Biomedical</a>
													<ul>
														<li><a href="/wiki/Bioinformatics"
																title="Bioinformatics">Bioinformatics</a></li>
														<li><a href="/wiki/Clinical_engineering"
																title="Clinical engineering">Clinical</a></li>
														<li><a href="/wiki/Health_technology"
																title="Health technology">Health technology</a></li>
												...
												<li><a href="/wiki/Building_services_engineering"
														title="Building services engineering">Building services</a>
													<ul>
														<li><a href="/wiki/Mechanical,_electrical,_and_plumbing"
																title="Mechanical, electrical, and plumbing">MEP</a>
														</li>
													</ul>
												</li>
												<li><a href="/wiki/Climate_engineering"
														title="Climate engineering">Geoengineering</a></li>
												<li><a href="/wiki/Corrosion_engineering"
														title="Corrosion engineering">Corrosion</a></li>
												<li><a href="/wiki/Engineering_management"
														title="Engineering management">Engineering management</a>
												</li>
												<li><a href="/wiki/Engineering_mathematics"
														title="Engineering mathematics">Engineering mathematics</a>
												</li>
												<li><a href="/wiki/Engineering_physics"
														title="Engineering physics">Engineering physics</a></li>
												<li><a href="/wiki/Explosives_engineering"
														title="Explosives engineering">Explosives</a></li>
												<li><a href="/wiki/Facilities_engineering"
														title="Facilities engineering">Facilities</a></li>
												<li><a href="/wiki/Fire_protection_engineering"
														title="Fire protection engineering">Fire</a></li>
												<li><a href="/wiki/Industrial_engineering"
														title="Industrial engineering">Industrial</a></li>
												<li><a href="/wiki/Information_engineering"
														title="Information engineering">Information</a></li>
												<li><a href="/wiki/Logistics_engineering"
														title="Logistics engineering">Logistics</a></li>
												<li><a href="/wiki/Materials_science"
														title="Materials science">Materials</a>
													<ul>
														<li><a href="/wiki/Ceramic_engineering"
																title="Ceramic engineering">Ceramics</a></li>
														<li><a href="/wiki/Metallurgy" title="Metallurgy">Metals</a>
														</li>
														<li><a href="/wiki/Plastics_engineering"
																title="Plastics engineering">Plastics</a></li>
														<li><a href="/wiki/Polymer_engineering"
																title="Polymer engineering">Polymers</a></li>
														<li><a href="/wiki/Surface_engineering"
												...
												<li><a href="/wiki/Military_engineering"
														title="Military engineering">Military</a></li>
												<li><a href="/wiki/Nanotechnology"
														title="Nanotechnology">Nanotechnology</a></li>
												<li><a href="/wiki/Nuclear_engineering"
														title="Nuclear engineering">Nuclear</a></li>
												<li><a href="/wiki/Ontology_engineering"
														title="Ontology engineering">Ontology</a></li>
												<li><a href="/wiki/Packaging_engineering"
														title="Packaging engineering">Packaging</a></li>
												<li><a href="/wiki/Piping" title="Piping">Piping</a></li>
												<li><a href="/wiki/Privacy_engineering"
														title="Privacy engineering">Privacy</a></li>
												<li><a href="/wiki/Safety_engineering"
														title="Safety engineering">Safety</a></li>
												<li><a href="/wiki/Security_engineering"
														title="Security engineering">Security</a></li>
												<li><a href="/wiki/Software_engineering"
														title="Software engineering">Software</a></li>
												<li><a href="/wiki/Systems_engineering"
														title="Systems engineering">Systems</a></li>
												<li><a href="/wiki/Textile_engineering" class="mw-redirect"
														title="Textile engineering">Textile</a></li>
											</ul>
										</div>
									</td>
								</tr>
					...
					<td class="noviewer navbox-image" rowspan="4" style="width:1px;padding:0 0 0 2px">
						<div><span typeof="mw:File"><a href="/wiki/File:Nuvola_apps_kcmsystem.png"
									class="mw-file-description"><img
										src="//upload.wikimedia.org/wikipedia/commons/thumb/3/35/Nuvola_apps_kcmsystem.png/50px-Nuvola_apps_kcmsystem.png"
										decoding="async" width="50" height="50" class="mw-file-element"
										srcset="//upload.wikimedia.org/wikipedia/commons/thumb/3/35/Nuvola_apps_kcmsystem.png/75px-Nuvola_apps_kcmsystem.png 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/3/35/Nuvola_apps_kcmsystem.png/100px-Nuvola_apps_kcmsystem.png 2x"
										data-file-width="128" data-file-height="128"></a></span></div>
					</td>
				</tr>
				<tr style="">
					<th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Engineering_education"
							title="Engineering education">Engineering education</a></th>
					<td class="navbox-list-with-group navbox-list navbox-even" style="width:100%;padding:0">
						<div style="padding:0 0.25em">
							<ul>
								<li><a href="/wiki/Bachelor_of_Engineering" title="Bachelor of Engineering">Bachelor
										of Engineering</a></li>
								<li><a href="/wiki/Master_of_Engineering" title="Master of Engineering">Master of
										Engineering</a></li>
								<li><a href="/wiki/Doctor_of_Engineering" title="Doctor of Engineering">Doctor of
										Engineering</a></li>
								<li><a href="/wiki/Engineer%27s_degree" title="Engineer's degree">Engineer's
										degree</a></li>
								<li><a href="/wiki/Engineering_studies" title="Engineering studies">Engineering
										studies</a></li>
							</ul>
						</div>
					</td>
				...
				<tr style="">
					...
					<td class="navbox-list-with-group navbox-list navbox-odd" style="width:100%;padding:0">
						<div style="padding:0 0.25em">
							<ul>
								<li><a href="/wiki/Engineer" title="Engineer">Engineer</a></li>
							</ul>
						</div>
					</td>
				</tr>
				<tr style="">
					<th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Glossary"
							title="Glossary">Glossaries</a></th>
					<td class="navbox-list-with-group navbox-list navbox-even" style="width:100%;padding:0">
						<div style="padding:0 0.25em">
							<ul>
								<li>Engineering
									<ul>
										<li><a href="/wiki/Glossary_of_engineering:_A%E2%80%93L"
												title="Glossary of engineering: A–L">A–L</a></li>
										<li><a href="/wiki/Glossary_of_engineering:_M%E2%80%93Z"
												title="Glossary of engineering: M–Z">M–Z</a></li>
									</ul>
								</li>
								<li><a href="/wiki/Glossary_of_aerospace_engineering"
										title="Glossary of aerospace engineering">Aerospace engineering</a></li>
								<li><a href="/wiki/Glossary_of_civil_engineering"
										title="Glossary of civil engineering">Civil engineering</a></li>
								<li><a href="/wiki/Glossary_of_electrical_and_electronics_engineering"
										title="Glossary of electrical and electronics engineering">Electrical and
										electronics engineering</a></li>
								<li><a href="/wiki/Glossary_of_mechanical_engineering"
										title="Glossary of mechanical engineering">Mechanical engineering</a></li>
								<li><a href="/wiki/Glossary_of_structural_engineering"
										title="Glossary of structural engineering">Structural engineering</a></li>
							</ul>
						</div>
					</td>
				</tr>
						...
						<div>
							<ul>
								<li><span class="noviewer" typeof="mw:File"><span title="Category"><img alt=""
										...
										href="/wiki/Category:Engineering" title="Category:Engineering">Category</a>
								</li>
								<li><span class="noviewer" typeof="mw:File"><span title="Commons page"><img alt=""
										...
										href="https://commons.wikimedia.org/wiki/Engineering" class="extiw"
										title="commons:Engineering">Commons</a></li>
